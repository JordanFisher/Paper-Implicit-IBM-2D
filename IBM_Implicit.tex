...
%\sum_{\mathbf{X}_k \in \mathcal{G}_B}  (\mathbf{e}_1^j)_k \delta_h (\mathbf{x}-\mathbf{X}_k) h_B \right)_i \\
...
\hfill
  \begin{center}
    \includegraphics[bb=0in 0in 7.7in 6.3in,width=4.8in,clip]{loglog2.pdf}
  \end{center}
