...
##[12.544000864028931, 27.484000682830811, 74.820004224777222, 130.58300399780273, 683.95598793029785]
##0.0267170307785
##[147.18600034713745, 294.75999784469604, 736.97099828720093, 1473.7029988765717, 7410.4979956150055]
##0.144733462151
##[530.08299970626831, 1060.6739962100983, 2656.392991065979]
##0.345750956137
##[1465.6279981136322, 2899.735996723175]
##0.707760428591
...
#####    raw_input("")
    ...
    for _T in Ts:
        if CurT < _T and CurT + dt >= _T:
            ...
            TrackTimes.append(TotalTime)
    print "Time:", CurT, TotalTime / count
    CurT += dt
